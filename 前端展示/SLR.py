...
class SLR:
    ...
    def get_action(self):
        ...
        # 若S→δ·∈ Ck ,(S为拓广文法开始符号）
        # 置ACTION(k,#)=acc
        omiga = self.rule[self.start]+self.point
        for k in self.C:
        ...
        while(True):
            ...
            if(action[0]=='S'):
                ...
                if log==True:
                    ...
                    f1.write("["+str(kk)+"]: "+substitude+" -> "+r_rule+'\n')
                    kk = kk+1
                    # ② A →V=E
                    if (substitude == 'A' and r_rule == "V=E"):
                        var = "( =, "+E_place.pop()+", ,"+V_place.pop()+" )"+"\n"
                        print(var)
                        f1.write(var)
                    ...
                    # ③ E(1)→E(2)+T
                        ...
                        E1_place = "temp"+str(t)
                        t=t+1
                        var = "( +, "+E_place.pop()+", "+T_place.pop()+", "+E1_place+" )"+"\n"
                        print(var)
                        f1.write(var)
                    ...
                    # ⑤ T(1)→ T(2)*F
                        ...
                        T1_place = "temp"+str(t)
                        t=t+1
                        var = "( *, "+T_place.pop()+", "+F_place.pop()+", "+T1_place+" )"+"\n"
                        print(var)
                        f1.write(var)
